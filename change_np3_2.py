...
for i in range(10):
    ...
    while True:
        if os.path.isfile(f"./data3_2/{i_number:04d}/{image_number:05d}.jpg"):
            pass
        else:
            break
        image_path = f"./data3_2/{i_number:04d}/{image_number:05d}.jpg"
        image_path2 = f"./data3_2/{i_number:04d}/00000.jpg"
