...
for i in range(396):
    ...
    image_number = 0
    while True:
        if os.path.isfile(f"./data3/{i_number:04d}/{image_number:05d}.jpg"):
            pass
        else:
            break
        image_path = f"./data3/{i_number:04d}/{image_number:05d}.jpg"
        image_path2 = f"./data3/{i_number:04d}/00000.jpg"
